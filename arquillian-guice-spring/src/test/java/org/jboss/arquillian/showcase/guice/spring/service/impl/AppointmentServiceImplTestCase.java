 ...
 */
package org.jboss.arquillian.showcase.guice.spring.service.impl;
...
public class AppointmentServiceImplTestCase {
    ...
    public static WebArchive createTestArchive() {
        return ShrinkWrap.create(WebArchive.class, "guice-test.war")
                ...
                .addAsResource(
                        AppointmentServiceImplTestCase.class.getClassLoader().getResource("applicationContext.xml"),
    ...
    private static File[] guiceSpringDependencies() {
        return resolveArtifact("com.google.inject.extensions:guice-spring");
    ...
    private static File[] springDependencies() {
        return resolveArtifact("org.springframework:spring-context");
    }
